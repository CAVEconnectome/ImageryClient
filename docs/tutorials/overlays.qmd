...
```
![Segmentation overlay with default colors](../example_images/seg_overlay_0.png)
...
![Segmentation overlay with specified color palette](../example_images/seg_overlay_1.png)
...
![Segmentation overlay with specified mapping between object id and color](../example_images/seg_overlay_2.png)
...
![Segmentation overlay using outlines instead of filled regions](../example_images/seg_outline_0.png)
...
![Segmentation overlay using distinct (unmerged) outlines](../example_images/seg_outline_1.png)
...
![One element of a series of stacked images](../example_images/seg_series_0.png)
...
![Series of cutouts from consecutive z-sections](../example_images/seg_series_full.png)
